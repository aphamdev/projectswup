...
@router.put("/swoops/accept/{pickup_id}", response_model=Union[
    Error, SwoopsAccept])
...
@router.put("/swoops/complete/{pickup_id}", response_model=Union[
    Error, SwoopsAccept])
...
@router.get("/pickups/{pickup_id}", response_model=Optional[
    SwoopsOutWithUsers])
